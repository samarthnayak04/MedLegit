...
export default function About() {
  ...
  return (
    <section className="min-h-screen p-8 bg-gradient-to-br from-gray-900 to-gray-800 text-white flex flex-col justify-center items-center">
      ...
      >
        We provide AI-assisted medical-legal solutions to streamline healthcare and legal workflows.
        Our platform empowers professionals to make faster, smarter, and fully informed decisions,
        combining cutting-edge technology with domain expertise for accuracy, transparency, and trust.
      </motion.p>
      ...
      >
        <button
          className="px-6 py-3 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-full shadow-lg font-medium hover:shadow-xl transition"
        >
          Learn More
        </button>
        <button
